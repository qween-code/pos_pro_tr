...
/// Mevcut ürünlere resim URL'leri ekleyen script
class ImageMigrationService {
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  /// Tüm mevcut ürünlere resim ekle
  Future<void> addImagesToExistingProducts() async {
    try {
      debugPrint('🖼️ Ürünlere resim ekleniyor...');
      ...
      debugPrint('✅ Tamamlandı! $updated ürün güncellendi, $skipped ürün atlandı');
    } catch (e) {
      debugPrint('❌ Hata: $e');
      rethrow;
    }
